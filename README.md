...
- По умолчанию в `Config` оставляется больше классов (редкие не склеиваются), а дисбаланс решается через **undersampling частых + WeightedRandomSampler для редких**.
